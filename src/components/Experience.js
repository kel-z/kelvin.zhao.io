        ...
        <div className="my-20">
          ...
          <div className="sm:grid grid-cols-4 gap-5">
            <div>
              <a href="https://www.paragontesting.ca/">
                <img
                  src={paragon}
                  alt="paragontesting"
                  className="justify-center cursor-pointer bg-white px-5 rounded-xl hover:-translate-y-1 hover:scale-[1.05] transition duration-200"
                />
              </a>
              <div className="flex flex-wrap">
                {skills.map((skill) => (
                  <>
                    <p className="bg-neutral-800 text-base rounded-lg pt-1 px-3 mr-2 mt-2">
            ...
            <div className="col-span-3 bg-neutral-900 mt-3 sm:mt-0 p-4 pt-3">
              ...
              <div className="flex flex-col justify-between sm:flex-row mb-3 border-b pb-3 border-neutral-800">
              ...
              <p className="mt-3 italic text-neutral-400">
                ...
                full-time full-stack developer, and I had the honour to meet
                many great people in my team. I worked on creating new APIs and
                features for the company's internal web applications, and I was
                able to learn a lot about the software development process.
              </p>
            </div>
          </div>
        </div>
