                ...
                <div className="sm:grid grid-cols-4 gap-5">
                    <div>
                        <a href="https://www.paragontesting.ca/">
                            <img src={paragon} alt="paragontesting" className="justify-center cursor-pointer bg-white px-5 rounded-xl hover:-translate-y-1 transition duration-200"/>
                        </a>
                        <div className="flex flex-wrap">
                        {paragonSkillsList}
                        </div>
                    </div>
                    <div className="col-span-3 bg-neutral-800 mt-3 sm:mt-0 p-4">
                        <div className="flex flex-col justify-between sm:flex-row">
                            <h5>Paragon Testing Enterprises</h5>
                            <h5 className="text-gray-500">Jan 2022 - Aug 2022</h5>
                        </div>
                        <div className="flex flex-col justify-between sm:flex-row mb-3 border-b">
                            <p>Software Developer Intern</p>
                            <p>Vancouver, BC, CAN</p>
                        </div>
                        <p className="">
                        ...
                        <p className="mt-3 italic text-gray-400">
                            My first internship! This was my first taste of being a real full-stack developer, and I had the honour to meet many great people in my team.
